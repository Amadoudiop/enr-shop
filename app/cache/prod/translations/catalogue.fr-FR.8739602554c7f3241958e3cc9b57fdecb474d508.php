...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'http://en.wikipedia.org/wiki/Comma-separated_values' => 'https://fr.wikipedia.org/wiki/Comma-separated_values',
  ...
  array (
    ...
    'Before being able to use this tool, you need to:
                            ...
                            <br />- Give it write permissions (CHMOD 666 on Unix system).' => 'Avant d\'utiliser cet outil, vous devez :
<br />- Créer un fichier .htaccess vide à la racine de votre site.
<br />- Donner les droits d\'écriture du fichier créé (CHMOD 666 sur les systèmes Unix).',
    ...
    '"%s" is an unauthorized keyword.' => '"%s" est un mot-clé non autorisé.',
  ...
  array (
    ...
    'Regulation following an inventory of stock' => 'Régularisation suite à inventaire',
    ...
    'Employee Edition' => 'Edition manuelle',
    'Values' => 'Valeurs',
    'Value' => 'Valeur',
    'Color' => 'Couleur',
  ...
  array (
    ...
    'No side columns, ideal for distraction-free pages such as product pages.' => 'Pas de colonne latérale ; idéal pour les pages sans distraction, comme les pages de produits.',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'The field %1$s is required at least in %2$s.' => 'Le champ %1$s est obligatoire au moins en %2$s.',
    '%s: Incorrect value' => '%s : valeur incorrecte',
    'Can\'t delete #%d' => 'Impossible de supprimer #%d',
