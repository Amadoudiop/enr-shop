        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<p class="title1" data-animation="animated blurFadeIn">TOP WELLNESS TRENDS 2017</p>
					<p class="title2" data-animation="animated blurFadeIn">Body Care Nourish <br /> & Refresh Your Skin</p>
					<p class="readmore" data-animation="animated blurFadeIn"><a href="#"><span>Shop now</span></a></p>
					</div>';
				}elseif($i==2){
					$slide->description[$language['id_lang']] = '<div class="info desc2">
					<p class="title1" data-animation="animated blurFadeIn">new arrivals</p>
					<p class="title2" data-animation="animated blurFadeIn">buy 2 items <br /> get one for free</p>
					<p class="readmore" data-animation="animated blurFadeIn"><a href="#"><span>Shop now</span></a></p>
					</div>';
				}else{
