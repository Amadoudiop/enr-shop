...
class Posbestsellers extends Module
{
	...
	function install()
	{
		...
		if (!Configuration::updateValue('SELLER_PRODUCTS_NBR', 20) OR !parent::install() OR !$this->registerHook('displayLeftColumn') OR !$this->registerHook('displayLeftColumnProduct') OR !$this->registerHook('displayBlockPosition1') OR !$this->registerHook('displayHeader'))
			return false;
		return true;
	}
