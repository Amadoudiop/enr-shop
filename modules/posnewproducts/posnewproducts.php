...
class Posnewproducts extends Module
{
	...
	function install()
	{
        ...
        Configuration::updateValue('POS_HOME_NEW_ITEMS', 1);
        Configuration::updateValue('POS_HOME_NEW_ROWS', 2);
		
		if (!Configuration::updateValue('NEW_PRODUCTS_NBR', 5) OR !parent::install() OR !$this->registerHook('displayBlockPosition3') OR !$this->registerHook('displayHeader'))
			return false;
		return true;
	}
